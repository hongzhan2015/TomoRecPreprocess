#!/usr/env/bin/python
### Modified from Bharat et al 2016 ######
...
import os, sys, subprocess, math, time, stat, glob, shutil
...
PathToCtffind = '/usr/local/ctffind/ctffind'     
...
for mic in micnames:
  ...
  print(headerline)
  status, sizevals = subprocess.getstatusoutput(headerline)
